# Comparing `tmp/confcls-0.1.3.tar.gz` & `tmp/confcls-0.1.4.tar.gz`
...
## Comparing `confcls-0.1.3.tar` & `confcls-0.1.4.tar`
...
### Comparing `confcls-0.1.3/LICENSE` & `confcls-0.1.4/LICENSE`

 * *Files identical despite different names*

### Comparing `confcls-0.1.3/README.md` & `confcls-0.1.4/README.md`

 * *Files identical despite different names*

### Comparing `confcls-0.1.3/confcls/configurable.py` & `confcls-0.1.4/confcls/configurable.py`

 * *Files identical despite different names*

### Comparing `confcls-0.1.3/pyproject.toml` & `confcls-0.1.4/pyproject.toml`
...
### Comparing `confcls-0.1.3/setup.py` & `confcls-0.1.4/setup.py`
...
### Comparing `confcls-0.1.3/PKG-INFO` & `confcls-0.1.4/PKG-INFO`
