# Comparing `tmp/confcls-0.1.2.tar.gz` & `tmp/confcls-0.1.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "confcls-0.1.2.tar", max compression
+gzip compressed data, was "confcls-0.1.3.tar", max compression
```

## Comparing `confcls-0.1.2.tar` & `confcls-0.1.3.tar`

### file list

```diff
@@ -1,8 +1,8 @@
--rw-r--r--   0        0        0     1480 2024-05-14 14:52:17.715267 confcls-0.1.2/LICENSE
--rw-r--r--   0        0        0     5227 2024-05-14 17:39:45.027017 confcls-0.1.2/README.md
--rw-r--r--   0        0        0      187 2024-05-14 09:51:31.518086 confcls-0.1.2/confcls/__init__.py
--rw-r--r--   0        0        0     2352 2024-05-14 08:53:55.090298 confcls-0.1.2/confcls/configurable.py
--rw-r--r--   0        0        0      494 2024-05-14 14:44:48.827305 confcls-0.1.2/confcls/object.py
--rw-r--r--   0        0        0      848 2024-05-14 17:39:15.650908 confcls-0.1.2/pyproject.toml
--rw-r--r--   0        0        0     6027 2024-05-14 17:39:45.413318 confcls-0.1.2/setup.py
--rw-r--r--   0        0        0     5915 2024-05-14 17:39:45.413562 confcls-0.1.2/PKG-INFO
+-rw-r--r--   0        0        0     1480 2024-05-14 14:52:17.715267 confcls-0.1.3/LICENSE
+-rw-r--r--   0        0        0     5227 2024-05-14 17:42:47.155646 confcls-0.1.3/README.md
+-rw-r--r--   0        0        0      187 2024-05-14 09:51:31.518086 confcls-0.1.3/confcls/__init__.py
+-rw-r--r--   0        0        0     2352 2024-05-14 08:53:55.090298 confcls-0.1.3/confcls/configurable.py
+-rw-r--r--   0        0        0      494 2024-05-14 14:44:48.827305 confcls-0.1.3/confcls/object.py
+-rw-r--r--   0        0        0      894 2024-05-14 17:42:17.383548 confcls-0.1.3/pyproject.toml
+-rw-r--r--   0        0        0     6027 2024-05-14 17:42:47.535368 confcls-0.1.3/setup.py
+-rw-r--r--   0        0        0     5966 2024-05-14 17:42:47.535611 confcls-0.1.3/PKG-INFO
```

### Comparing `confcls-0.1.2/LICENSE` & `confcls-0.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `confcls-0.1.2/README.md` & `confcls-0.1.3/README.md`

 * *Files identical despite different names*

### Comparing `confcls-0.1.2/confcls/configurable.py` & `confcls-0.1.3/confcls/configurable.py`

 * *Files identical despite different names*

### Comparing `confcls-0.1.2/pyproject.toml` & `confcls-0.1.3/pyproject.toml`
...
### Comparing `confcls-0.1.2/setup.py` & `confcls-0.1.3/setup.py`
...
### Comparing `confcls-0.1.2/PKG-INFO` & `confcls-0.1.3/PKG-INFO`
