# Comparing `tmp/confcls-0.1.0.tar.gz` & `tmp/confcls-0.1.1.tar.gz`
...
## Comparing `confcls-0.1.0.tar` & `confcls-0.1.1.tar`
...
### Comparing `confcls-0.1.0/LICENSE` & `confcls-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `confcls-0.1.0/README.md` & `confcls-0.1.1/README.md`

 * *Files identical despite different names*

### Comparing `confcls-0.1.0/confcls/configurable.py` & `confcls-0.1.1/confcls/configurable.py`

 * *Files identical despite different names*

### Comparing `confcls-0.1.0/pyproject.toml` & `confcls-0.1.1/pyproject.toml`
...
### Comparing `confcls-0.1.0/setup.py` & `confcls-0.1.1/setup.py`
...
### Comparing `confcls-0.1.0/PKG-INFO` & `confcls-0.1.1/PKG-INFO`
