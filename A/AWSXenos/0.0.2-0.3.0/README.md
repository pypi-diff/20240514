# Comparing `tmp/AWSXenos-0.0.2.tar.gz` & `tmp/awsxenos-0.3.0.tar.gz`
...
## Comparing `AWSXenos-0.0.2.tar` & `awsxenos-0.3.0.tar`
...
### Comparing `AWSXenos-0.0.2/LICENSE` & `awsxenos-0.3.0/LICENSE`

 * *Files identical despite different names*

### Comparing `AWSXenos-0.0.2/awsxenos/report.py` & `awsxenos-0.3.0/awsxenos/report.py`
...
### Comparing `AWSXenos-0.0.2/awsxenos/template.html` & `awsxenos-0.3.0/awsxenos/template.html`

 * *Files identical despite different names*

### Comparing `AWSXenos-0.0.2/setup.py` & `awsxenos-0.3.0/setup.py`
...
### Comparing `AWSXenos-0.0.2/tests/fixtures.py` & `awsxenos-0.3.0/tests/fixtures.py`
