# Comparing `tmp/tejd_build_tools-1.7.0.dev0-py3-none-any.whl.zip` & `tmp/tejd_build_tools-1.7.0.dev1-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,9 +1,11 @@
-Zip file size: 691729 bytes, number of entries: 198
--rw-r--r--  2.0 unx       26 b- defN 24-May-14 19:14 tejd_build_tools/__init__.py
...
--rw-r--r--  2.0 unx    10142 b- defN 24-May-14 19:14 tejd_build_tools-1.7.0.dev0.dist-info/LICENSE
--rw-r--r--  2.0 unx      151 b- defN 24-May-14 19:14 tejd_build_tools-1.7.0.dev0.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 24-May-14 19:14 tejd_build_tools-1.7.0.dev0.dist-info/WHEEL
--rw-r--r--  2.0 unx       17 b- defN 24-May-14 19:14 tejd_build_tools-1.7.0.dev0.dist-info/top_level.txt
--rw-rw-r--  2.0 unx    24940 b- defN 24-May-14 19:14 tejd_build_tools-1.7.0.dev0.dist-info/RECORD
-198 files, 3842703 bytes uncompressed, 649347 bytes compressed:  83.1%
...
```diff
@@ -1,10 +1,16 @@
+Filename: tejd_build_tools/VERSION
+Comment: 
+
 Filename: tejd_build_tools/__init__.py
 Comment: 
 
+Filename: tejd_build_tools/te_version.py
+Comment: 
+
 Filename: tejd_build_tools/build_tools/__init__.py
 Comment: 
...
-Filename: tejd_build_tools-1.7.0.dev0.dist-info/LICENSE
+Filename: tejd_build_tools-1.7.0.dev1.dist-info/LICENSE
 Comment: 
 
-Filename: tejd_build_tools-1.7.0.dev0.dist-info/METADATA
+Filename: tejd_build_tools-1.7.0.dev1.dist-info/METADATA
 Comment: 
 
-Filename: tejd_build_tools-1.7.0.dev0.dist-info/WHEEL
+Filename: tejd_build_tools-1.7.0.dev1.dist-info/WHEEL
 Comment: 
 
-Filename: tejd_build_tools-1.7.0.dev0.dist-info/top_level.txt
+Filename: tejd_build_tools-1.7.0.dev1.dist-info/top_level.txt
 Comment: 
 
-Filename: tejd_build_tools-1.7.0.dev0.dist-info/RECORD
...
## Comparing `tejd_build_tools-1.7.0.dev0.dist-info/LICENSE` & `tejd_build_tools-1.7.0.dev1.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `tejd_build_tools-1.7.0.dev0.dist-info/RECORD` & `tejd_build_tools-1.7.0.dev1.dist-info/RECORD`

 * *Files 1% similar despite different names*

```diff
@@ -1,8 +1,10 @@
-tejd_build_tools/__init__.py,sha256=SGORKlOHPPe6NzNJBWtSbFhQMMKuLNFo5-rAXwjWJak,26
...
-tejd_build_tools-1.7.0.dev0.dist-info/LICENSE,sha256=vqG0Jm8UmfpLuxbW51d-a1tT0e8BCDWp1GCHYCLMhyI,10142
-tejd_build_tools-1.7.0.dev0.dist-info/METADATA,sha256=LxsRcv4OXO48rtERUN7t9MZeCPCv1YIdN98vJhjzf4w,151
-tejd_build_tools-1.7.0.dev0.dist-info/WHEEL,sha256=oiQVh_5PnQM0E3gPdiz09WCNmwiHDMaGer_elqB3coM,92
-tejd_build_tools-1.7.0.dev0.dist-info/top_level.txt,sha256=KPLvv8ekYraJSt7QjK0ByGJElFL3k4YpDq7p0K0H6y0,17
-tejd_build_tools-1.7.0.dev0.dist-info/RECORD,,
