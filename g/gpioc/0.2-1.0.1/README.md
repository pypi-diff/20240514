# Comparing `tmp/gpioc-0.2.tar.gz` & `tmp/gpioc-1.0.1.tar.gz`
...
+gzip compressed data, was "gpioc-1.0.1.tar", last modified: Tue May 14 06:59:19 2024, max compression
```

## Comparing `gpioc-0.2.tar` & `gpioc-1.0.1.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:19.868112 gpioc-1.0.1/
+-rwxr-xr-x   0 runner    (1001) docker     (127)     1063 2024-05-14 06:59:11.000000 gpioc-1.0.1/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (127)       76 2024-05-14 06:59:11.000000 gpioc-1.0.1/MANIFEST.in
+-rw-r--r--   0 runner    (1001) docker     (127)      831 2024-05-14 06:59:19.868112 gpioc-1.0.1/PKG-INFO
+-rwxr-xr-x   0 runner    (1001) docker     (127)     2498 2024-05-14 06:59:11.000000 gpioc-1.0.1/README.md
+-rw-r--r--   0 runner    (1001) docker     (127)      562 2024-05-14 06:59:11.000000 gpioc-1.0.1/README_PY.md
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:19.864112 gpioc-1.0.1/examples-python/
+-rwxr-xr-x   0 runner    (1001) docker     (127)      274 2024-05-14 06:59:11.000000 gpioc-1.0.1/examples-python/gpio.py
+-rwxr-xr-x   0 runner    (1001) docker     (127)      198 2024-05-14 06:59:11.000000 gpioc-1.0.1/examples-python/pwm.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:19.864112 gpioc-1.0.1/gpioc/
+-rwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:11.000000 gpioc-1.0.1/gpioc/__init__.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:19.864112 gpioc-1.0.1/gpioc/chips/
+-rwxr-xr-x   0 runner    (1001) docker     (127)     1103 2024-05-14 06:59:11.000000 gpioc-1.0.1/gpioc/chips/H616.py
+-rwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:11.000000 gpioc-1.0.1/gpioc/chips/__init__.py
+-rwxr-xr-x   0 runner    (1001) docker     (127)     2997 2024-05-14 06:59:11.000000 gpioc-1.0.1/gpioc/pin.py
+-rwxr-xr-x   0 runner    (1001) docker     (127)     1136 2024-05-14 06:59:11.000000 gpioc-1.0.1/gpioc/pwm.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:19.868112 gpioc-1.0.1/gpioc.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)      831 2024-05-14 06:59:19.000000 gpioc-1.0.1/gpioc.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      590 2024-05-14 06:59:19.000000 gpioc-1.0.1/gpioc.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-14 06:59:19.000000 gpioc-1.0.1/gpioc.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        6 2024-05-14 06:59:19.000000 gpioc-1.0.1/gpioc.egg-info/top_level.txt
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-14 06:59:19.868112 gpioc-1.0.1/libgpio/
+-rwxr-xr-x   0 runner    (1001) docker     (127)      239 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/Makefile
+-rw-r--r--   0 runner    (1001) docker     (127)    16384 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/board.c
+-rw-r--r--   0 runner    (1001) docker     (127)     1612 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/board.h
+-rw-r--r--   0 runner    (1001) docker     (127)      809 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/gpio.h
+-rw-r--r--   0 runner    (1001) docker     (127)     1612 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/pinctrl-sun50i-h616-r.c
+-rw-r--r--   0 runner    (1001) docker     (127)    22484 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/pinctrl-sun50i-h616.c
+-rw-r--r--   0 runner    (1001) docker     (127)     8811 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/pinctrl-sunxi.c
+-rw-r--r--   0 runner    (1001) docker     (127)     8132 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/pinctrl-sunxi.h
+-rwxr-xr-x   0 runner    (1001) docker     (127)     1848 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/pinctrl.c
+-rwxr-xr-x   0 runner    (1001) docker     (127)      607 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/pinctrl.h
+-rwxr-xr-x   0 runner    (1001) docker     (127)     2359 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/pinctrl_py.c
+-rwxr-xr-x   0 runner    (1001) docker     (127)     4608 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/softpwm.c
+-rwxr-xr-x   0 runner    (1001) docker     (127)      348 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/softpwm.h
+-rwxr-xr-x   0 runner    (1001) docker     (127)     2600 2024-05-14 06:59:11.000000 gpioc-1.0.1/libgpio/softpwm_py.c
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-14 06:59:19.868112 gpioc-1.0.1/setup.cfg
+-rwxr-xr-x   0 runner    (1001) docker     (127)      984 2024-05-14 06:59:11.000000 gpioc-1.0.1/setup.py
```

### Comparing `gpioc-0.2/LICENSE` & `gpioc-1.0.1/LICENSE`

 * *Files identical despite different names*

### Comparing `gpioc-0.2/gpioc/_pin.py` & `gpioc-1.0.1/gpioc/pin.py`
...
### Comparing `gpioc-0.2/gpioc/_pwm.py` & `gpioc-1.0.1/gpioc/pwm.py`
...
### Comparing `gpioc-0.2/setup.py` & `gpioc-1.0.1/setup.py`
...
### Comparing `gpioc-0.2/src/gpioc.c` & `gpioc-1.0.1/libgpio/pinctrl.c`
...
### Comparing `gpioc-0.2/src/gpioc_py.c` & `gpioc-1.0.1/libgpio/pinctrl_py.c`
...
### Comparing `gpioc-0.2/src/softpwm.c` & `gpioc-1.0.1/libgpio/softpwm.c`
...
### Comparing `gpioc-0.2/src/softpwm_py.c` & `gpioc-1.0.1/libgpio/softpwm_py.c`
