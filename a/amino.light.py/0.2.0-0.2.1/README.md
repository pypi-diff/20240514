# Comparing `tmp/amino.light.py-0.2.0.tar.gz` & `tmp/amino.light.py-0.2.1.tar.gz`
...
+gzip compressed data, was "amino.light.py-0.2.1.tar", last modified: Tue May 14 18:08:34 2024, max compression
```

## Comparing `amino.light.py-0.2.0.tar` & `amino.light.py-0.2.1.tar`
...
+drwxrwxrwx   0        0        0        0 2024-05-14 18:08:34.793543 amino.light.py-0.2.1/
+drwxrwxrwx   0        0        0        0 2024-05-14 18:08:34.688545 amino.light.py-0.2.1/AminoLightPy/
+-rw-rw-rw-   0        0        0      297 2024-05-14 18:07:33.000000 amino.light.py-0.2.1/AminoLightPy/__init__.py
+-rw-rw-rw-   0        0        0    17290 2024-05-07 00:05:13.000000 amino.light.py-0.2.1/AminoLightPy/acm.py
+-rw-rw-rw-   0        0        0    17024 2024-05-09 21:42:39.000000 amino.light.py-0.2.1/AminoLightPy/amino_socket.py
+-rw-rw-rw-   0        0        0    74921 2024-05-14 17:48:33.000000 amino.light.py-0.2.1/AminoLightPy/client.py
+-rw-rw-rw-   0        0        0     2609 2024-05-14 18:02:11.000000 amino.light.py-0.2.1/AminoLightPy/constants.py
+drwxrwxrwx   0        0        0        0 2024-05-14 18:08:34.690544 amino.light.py-0.2.1/AminoLightPy/lib/
+-rw-rw-rw-   0        0        0        0 2024-04-19 03:59:31.000000 amino.light.py-0.2.1/AminoLightPy/lib/__init__.py
+drwxrwxrwx   0        0        0        0 2024-05-14 18:08:34.695544 amino.light.py-0.2.1/AminoLightPy/lib/util/
+-rw-rw-rw-   0        0        0       75 2024-04-19 03:26:32.000000 amino.light.py-0.2.1/AminoLightPy/lib/util/__init__.py
+-rw-rw-rw-   0        0        0    32832 2024-04-24 14:57:25.000000 amino.light.py-0.2.1/AminoLightPy/lib/util/exceptions.py
+-rw-rw-rw-   0        0        0     1846 2024-04-24 14:57:20.000000 amino.light.py-0.2.1/AminoLightPy/lib/util/helpers.py
+-rw-rw-rw-   0        0        0    95691 2024-05-14 17:40:03.000000 amino.light.py-0.2.1/AminoLightPy/lib/util/objects.py
+-rw-rw-rw-   0        0        0      896 2024-05-06 23:33:35.000000 amino.light.py-0.2.1/AminoLightPy/managers.py
+-rw-rw-rw-   0        0        0    79529 2024-05-14 17:47:20.000000 amino.light.py-0.2.1/AminoLightPy/sub_client.py
+-rw-rw-rw-   0        0        0     1089 2024-04-06 02:55:57.000000 amino.light.py-0.2.1/LICENSE
+-rw-rw-rw-   0        0        0     3630 2024-05-14 18:08:34.792541 amino.light.py-0.2.1/PKG-INFO
+-rw-rw-rw-   0        0        0     2834 2024-04-19 02:52:28.000000 amino.light.py-0.2.1/README.md
+drwxrwxrwx   0        0        0        0 2024-05-14 18:08:34.791543 amino.light.py-0.2.1/amino.light.py.egg-info/
+-rw-rw-rw-   0        0        0     3630 2024-05-14 18:08:33.000000 amino.light.py-0.2.1/amino.light.py.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      565 2024-05-14 18:08:33.000000 amino.light.py-0.2.1/amino.light.py.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2024-05-14 18:08:33.000000 amino.light.py-0.2.1/amino.light.py.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       26 2024-05-14 18:08:33.000000 amino.light.py-0.2.1/amino.light.py.egg-info/requires.txt
+-rw-rw-rw-   0        0        0       13 2024-05-14 18:08:33.000000 amino.light.py-0.2.1/amino.light.py.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2024-05-14 18:08:34.798545 amino.light.py-0.2.1/setup.cfg
+-rw-rw-rw-   0        0        0     1298 2024-05-14 18:07:51.000000 amino.light.py-0.2.1/setup.py
```

### Comparing `amino.light.py-0.2.0/AminoLightPy/acm.py` & `amino.light.py-0.2.1/AminoLightPy/acm.py`

 * *Files identical despite different names*

### Comparing `amino.light.py-0.2.0/AminoLightPy/amino_socket.py` & `amino.light.py-0.2.1/AminoLightPy/amino_socket.py`
...
### Comparing `amino.light.py-0.2.0/AminoLightPy/client.py` & `amino.light.py-0.2.1/AminoLightPy/client.py`
...
### Comparing `amino.light.py-0.2.0/AminoLightPy/constants.py` & `amino.light.py-0.2.1/AminoLightPy/constants.py`
...
### Comparing `amino.light.py-0.2.0/AminoLightPy/lib/util/exceptions.py` & `amino.light.py-0.2.1/AminoLightPy/lib/util/exceptions.py`

 * *Files identical despite different names*

### Comparing `amino.light.py-0.2.0/AminoLightPy/lib/util/helpers.py` & `amino.light.py-0.2.1/AminoLightPy/lib/util/helpers.py`

 * *Files identical despite different names*

### Comparing `amino.light.py-0.2.0/AminoLightPy/managers.py` & `amino.light.py-0.2.1/AminoLightPy/managers.py`

 * *Files identical despite different names*

### Comparing `amino.light.py-0.2.0/AminoLightPy/sub_client.py` & `amino.light.py-0.2.1/AminoLightPy/sub_client.py`
...
### Comparing `amino.light.py-0.2.0/LICENSE` & `amino.light.py-0.2.1/LICENSE`

 * *Files identical despite different names*

### Comparing `amino.light.py-0.2.0/PKG-INFO` & `amino.light.py-0.2.1/PKG-INFO`
...
+Metadata-Version: 2.1 Name: amino.light.py Version: 0.2.1 Summary: Best
...
### Comparing `amino.light.py-0.2.0/README.md` & `amino.light.py-0.2.1/README.md`

 * *Files identical despite different names*

### Comparing `amino.light.py-0.2.0/amino.light.py.egg-info/PKG-INFO` & `amino.light.py-0.2.1/amino.light.py.egg-info/PKG-INFO`
...
### Comparing `amino.light.py-0.2.0/amino.light.py.egg-info/SOURCES.txt` & `amino.light.py-0.2.1/amino.light.py.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `amino.light.py-0.2.0/setup.py` & `amino.light.py-0.2.1/setup.py`
