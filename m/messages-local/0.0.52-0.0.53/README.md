# Comparing `tmp/messages_local-0.0.52.tar.gz` & `tmp/messages_local-0.0.53.tar.gz`
...
## Comparing `messages_local-0.0.52.tar` & `messages_local-0.0.53.tar`
...
### Comparing `messages_local-0.0.52/PKG-INFO` & `messages_local-0.0.53/PKG-INFO`
...
### Comparing `messages_local-0.0.52/README.md` & `messages_local-0.0.53/README.md`

 * *Files identical despite different names*

### Comparing `messages_local-0.0.52/messages_local/src/MessagesLocal.py` & `messages_local-0.0.53/messages_local/src/MessagesLocal.py`

 * *Files identical despite different names*

### Comparing `messages_local-0.0.52/messages_local.egg-info/PKG-INFO` & `messages_local-0.0.53/messages_local.egg-info/PKG-INFO`
...
### Comparing `messages_local-0.0.52/setup.py` & `messages_local-0.0.53/setup.py`
